...
class FishingMinigameRodCastUIRenderer(override val minigameState: FishingMinigameRodCastState): FishingMinigameUIRenderer() {
    ...
    override fun render() {
        ...
        when (minigameState.stateTicksPassed) {
            in 0 until plugin.config.fishingMinigame.bigRodCharacters.size -> {
                renderCharacterSeparately(title, plugin.config.fishingMinigame.bigRodCharacters[minigameState.stateTicksPassed], plugin.config.fishingMinigame.bigRodPosition, plugin.config.fishingMinigame.bigRodCharacterHeight)
            }
            else -> renderCharacterSeparately(title, plugin.config.fishingMinigame.bigRodCharacters[plugin.config.fishingMinigame.bigRodCharacters.size - 1], plugin.config.fishingMinigame.bigRodPosition, plugin.config.fishingMinigame.bigRodCharacterHeight)
        }
